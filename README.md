...
main.ipynb: Jupyter notebook with description of the problem and high level explanation fo the concepts.

frontEnd.py: Script with a simple GUI to run the code.
